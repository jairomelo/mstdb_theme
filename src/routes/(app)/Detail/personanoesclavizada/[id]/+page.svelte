...
<svelte:head>
	<title
		>{pernoesc
			? `${pernoesc.nombre_normalizado} — Persona No Esclavizada — Trayectorias Afro`
			: 'Persona No Esclavizada — Trayectorias Afro'}</title
	>
</svelte:head>
	...
	{:else if pernoesc}
		<div class="entity-banner persona-no-esclavizada">
			...
			<div class="d-flex align-items-center gap-2 flex-wrap mt-1">
				...
				<SuggestMerge
					entity="pn"
					currentId={pernoesc.persona_id}
					currentLabel={pernoesc.nombre_normalizado}
				/>
			</div>
		</div>
			...
			{#if pernoesc.edad}
				<div class="detail">
					...
					<div class="detail-bottom">
						<p>{pernoesc.edad} {pernoesc.unidad_temporal_edad || 'años'}</p>
					</div>
				</div>
			{/if}
		</div>
				...
				>
					<div>
						<h2 class="card-title h5 mb-0">
							<i class="bi bi-geo-alt me-2"></i>Lugares relacionados
						</h2>
