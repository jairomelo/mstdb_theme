<script>
    ...
    const HONORIFICOS = [
        { value: 'nan', label: 'N/A' }, { value: 'don', label: 'Don' },
        { value: 'dna', label: 'Doña' }, { value: 'doc', label: 'Doctor' },
    ...
    function reset() {
        nombres = ''; apellidos = ''; sexo = ''; honorifico = 'nan'; entidad_asociada = '';
        documentos = []; calidades = []; lugar_nacimiento = null; fecha_nacimiento_raw = '';
        fecha_nacimiento_factual = false; lugar_defuncion = null; fecha_defuncion_raw = '';
        fecha_defuncion_factual = false; estado_civil = []; ocupaciones = [];
        ocupacion_categoria = ''; notas = ''; created = null; errors = {};
    }
</script>
