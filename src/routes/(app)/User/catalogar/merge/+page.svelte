...
<div class="container-fluid mt-3" style="max-width: 900px;">
	...
	<div class="alert alert-warning" role="note">
		...
		<strong>Operación destructiva.</strong> El registro duplicado se eliminará permanentemente y todos
		sus vínculos se transferirán al registro canónico.
	</div>
		...
		{#if candidates.length}
			<div class="card mb-3">
				<div class="card-header fw-semibold">
					...
					<small class="text-muted"
						>Selecciona el registro canónico (verde) y el duplicado (rojo)</small
					>
				</div>
							...
							{#each candidates as c}
								...
								<tr class:table-success={isCanon} class:table-danger={isDup}>
									...
									<td class="text-center">
										<button
											class="btn btn-sm {isCanon ? 'btn-success' : 'btn-outline-success'}"
									...
									<td class="text-center">
										<button
											class="btn btn-sm {isDup ? 'btn-danger' : 'btn-outline-danger'}"
											aria-pressed={isDup}
			...
			<div class="d-flex gap-2 mb-4">
				<button
					...
					on:click={goConfirm}
					disabled={!canonicalRecord || !duplicateRecord}
				>
		...
		<div class="card mb-3 border-danger">
			...
			<div class="card-body">
				...
				<p class="text-danger fw-semibold mb-3">
					...
					El registro ID {duplicateRecord.id} se eliminará. Todos sus vínculos (documentos, relaciones,
					trayectorias) se transferirán a ID {canonicalRecord.id}.
				</p>
