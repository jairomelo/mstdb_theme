...
export const columnsConfig = {
    personaesclavizada: [
        ...
        { key: 'procedencia', label: 'Procedencia', sortable: false, visible: true },
        { key: 'estado_civil', label: 'Estado matrimonial', sortable: false, visible: true },
        ...
        { key: 'documented_span', label: 'Periodo (años)', sortable: false, visible: false },
        { key: 'altura', label: 'Altura', sortable: false, visible: false },
        { key: 'cabello', label: 'Cabello', sortable: false, visible: false },
        { key: 'ojos', label: 'Ojos', sortable: false, visible: false },
        { key: 'marcas_corporales', label: 'Marcas corporales', sortable: false, visible: false },
        { key: 'conducta', label: 'Conducta', sortable: false, visible: false },
        { key: 'salud', label: 'Salud', sortable: false, visible: false },
...
export const filtersDefinition = {
    personaesclavizada: [
        ...
        {
            key: 'estado_civil', label: 'Estado matrimonial', type: 'select',
            options: [
                { value: '', label: 'Todos' },
        ...
        { key: 'tipo_documental', label: 'Tipo documental', type: 'searchable-select', facetKey: 'tipos_documentales' },
        { key: 'archivo', label: 'Archivo', type: 'id-searchable-select', facetKey: 'archivos' },
        ...
        { key: 'altura__icontains', label: 'Altura', type: 'text', placeholder: 'Buscar altura...' },
        { key: 'cabello__icontains', label: 'Cabello', type: 'text', placeholder: 'Buscar cabello...' },
        { key: 'ojos__icontains', label: 'Ojos', type: 'text', placeholder: 'Buscar ojos...' },
        { key: 'marcas_corporales__icontains', label: 'Marcas corporales', type: 'text', placeholder: 'Buscar marcas...' },
        { key: 'conducta__icontains', label: 'Conducta', type: 'text', placeholder: 'Buscar conducta...' },
        { key: 'salud__icontains', label: 'Salud', type: 'text', placeholder: 'Buscar salud...' },
