...
<div class="list-group-item list-group-item-action">
    <div class="row">
        <div class="col-md-6">
            <a href="/Detail/personaNoEsclavizada/{item.source.persona_id}">
                <h5 class="mb-2">
            ...
            <small class="identifier">{item.source.persona_idno || ''}</small><br />
    ...
    {#if item.persona_x_persona_rel && item.persona_x_persona_rel.length > 0}
        <div class="row mt-2">
            <div class="col-md-12">
