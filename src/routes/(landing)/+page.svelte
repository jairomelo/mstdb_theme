		...
		>
			...
			<div class="hero-filter-options mt-2">
				<button
					...
					class:active={currentFilter === 'documentos'}
					on:click={() => setFilter('documentos')}>Documentos</button
				>
				<button
					type="button"
					class="btn btn-outline-light"
					class:active={currentFilter === 'personas_esclavizadas'}
					on:click={() => setFilter('personas_esclavizadas')}>Personas Esclavizadas</button
				>
				<button
					type="button"
					class="btn btn-outline-light"
					class:active={currentFilter === 'personas_no_esclavizadas'}
					on:click={() => setFilter('personas_no_esclavizadas')}>Personas No Esclavizadas</button
				>
				<button
					type="button"
					class="btn btn-outline-light"
					class:active={currentFilter === 'corporaciones'}
					on:click={() => setFilter('corporaciones')}>Corporaciones</button
				>
				<button
					type="button"
					class="btn btn-outline-light"
