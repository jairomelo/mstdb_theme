...
<div class="container mt-4">
	...
	<div class="alert alert-info py-2" role="note">
		...
		<small>
			La georreferenciación se registra directamente aquí: crea el lugar con sus coordenadas y
			jerarquía («Es parte de»). Los lugares existentes se editan desde su página de detalle.
		</small>
	</div>
	...
	{#if created}
		<div class="alert alert-success d-flex align-items-center justify-content-between" role="alert">
			<span
				>Lugar creado: <strong>{created.short_id}</strong> — {created.nombre_lugar ??
					nombre_lugar}</span
			>
			...
			<div class="card-body row g-3">
				...
				<div class="col-md-6">
					<FormField
						...
						hint="Nombres alternativos o variantes"
					>
						<textarea id="otros" class="form-control" rows="2" bind:value={otros_nombres}
						></textarea>
					</FormField>
				</div>
				<div class="col-md-6">
