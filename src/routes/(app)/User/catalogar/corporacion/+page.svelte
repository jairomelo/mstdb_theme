...
<div class="container mt-4">
	...
	{#if created}
		<div class="alert alert-success d-flex align-items-center justify-content-between" role="alert">
			<span
				>Corporación creada: <strong>{created.short_id ?? created.corporacion_idno}</strong> — {created.nombre_institucion ??
					nombre_institucion}</span
			>
		...
		<section class="card mb-4">
			...
			<div class="card-body row g-3">
				...
				<div class="col-12">
					...
					>
						<textarea id="alt" class="form-control" rows="2" bind:value={nombres_alternativos}
						></textarea>
					</FormField>
				</div>
				<div class="col-md-6">
