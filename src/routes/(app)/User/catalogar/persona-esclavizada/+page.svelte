		...
		<div class="alert alert-success" role="alert">
			<div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
				...
				<div class="d-flex gap-2 flex-wrap">
					<a
						href="/User/trayectoria?persona_id={created.persona_id}"
						class="btn btn-sm btn-outline-success"
					>
						<i class="bi bi-map me-1"></i>Editar trayectoria
					</a>
					<a
						href="/User/catalogar/relaciones?persona_id={created.persona_id}"
						class="btn btn-sm btn-outline-success"
					>
			...
			<div class="card-body row g-3">
				...
				<div class="col-12">
					<FormField
						...
						id="documentos"
						required
						hint="Al menos un documento fuente"
						error={fieldError('documentos')}
					>
						<MultiSelect
							id="documentos"
			...
			<div class="card-body row g-3">
				<div class="col-md-6">
					<FormField label="Hispanizaciones" id="hisp" error={fieldError('hispanizacion')}>
						<MultiSelect
							id="hisp"
							bind:values={hispanizacion}
							endpoint="vocabularios/hispanizaciones/"
						/>
					</FormField>
				</div>
				<div class="col-md-6">
				...
				<div class="col-md-6">
					<FormField
						label="Procedencia adicional"
						id="proc-add"
						error={fieldError('procedencia_adicional')}
					>
			...
			<div class="card-body row g-3">
				<div class="col-md-6">
					<FormField label="Marcas corporales" id="marcas" error={fieldError('marcas_corporales')}>
						<textarea id="marcas" class="form-control" rows="3" bind:value={marcas_corporales}
						></textarea>
					</FormField>
				</div>
				<div class="col-md-6">
